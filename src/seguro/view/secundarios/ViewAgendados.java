...
public class ViewAgendados extends javax.swing.JInternalFrame {
   ...
   private ControlAgendados control;
   /**
   ...
   private void initComponents() {
      ...
      lista_desligados = new javax.swing.JTable();
      ...
      lista_desligados.setModel(new javax.swing.table.DefaultTableModel(
         new Object [][] {
            {null, null, null, null},
            {null, null, null, null},
            {null, null, null, null},
      ...
      lista_desligados.setGridColor(new java.awt.Color(0, 153, 153));
      jScrollPane2.setViewportView(lista_desligados);
   ...
   private void excluir_agendadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excluir_agendadoActionPerformed
      if( tabela_agendados.getRowCount() > 0 ){
         if( tabela_agendados.getSelectedRow() >= 0) {
         int i = JOptionPane.showConfirmDialog(this, "Deseja Mesmo excluir este agendandamento?","Exclusão",2);
            if( i == 0 ) {
              int linha = tabela_agendados.getSelectedRow();
              
              this.control.removeDB( (int) tabela_agendados.getValueAt(linha, 0 ) );
   ...
   private javax.swing.JTable lista_desligados;
   private javax.swing.JPanel panelTable;
   public static javax.swing.JTable tabela_agendados;
   ...
   public RSButtonMetro getExcluir_agendado() {
    ...
    public JTable getLista_desligados() {
        return lista_desligados;
    }

    public void setLista_desligados(JTable lista_desligados) {
        this.lista_desligados = lista_desligados;
    }
